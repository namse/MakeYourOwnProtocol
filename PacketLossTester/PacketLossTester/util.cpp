...
int Login(unsigned int channel, unsigned int id, int lossRate , int sockfd)
{
...
int Send(char* buf, size_t length, int sockfd, ChannelNumber channel, ID id)
{
...
ssize_t Recv(char* buf, int maxLength, int sockfd)
{
